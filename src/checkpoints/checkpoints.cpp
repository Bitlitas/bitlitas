...
#define BITLITAS_DEFAULT_LOG_CATEGORY "checkpoints"
...
namespace cryptonote
{
  ...
  bool checkpoints::load_checkpoints_from_dns(bool testnet)
  {
    ...
    static const std::vector<std::string> dns_urls = { "checkpoints.bitlitaspulse.se"
						     , "checkpoints.bitlitaspulse.org"
						     , "checkpoints.bitlitaspulse.net"
						     , "checkpoints.bitlitaspulse.co"
    };

    static const std::vector<std::string> testnet_dns_urls = { "testpoints.bitlitaspulse.se"
							     , "testpoints.bitlitaspulse.org"
							     , "testpoints.bitlitaspulse.net"
							     , "testpoints.bitlitaspulse.co"
    };
