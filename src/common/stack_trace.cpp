...
#define BITLITAS_DEFAULT_LOG_CATEGORY "stacktrace"

#define ST_LOG(x) CINFO(el::base::Writer,el::base::DispatchAction::FileOnlyLog,BITLITAS_DEFAULT_LOG_CATEGORY) << x
