...
STATIC INLINE int force_software_aes(void)
{
  ...
  const char *env = getenv("BITLITAS_USE_SOFTWARE_AES");
  if (!env) {
    use = 0;
  }
 ...
 * function outside of Bitlitas without caution!  This version uses the hardware
...
/**
 * @brief the hash function implementing CryptoNight, used for the Bitlitas proof-of-work
 *
