...
int main(int argc, char const * argv[])
{
  try {
    ...
    {
      std::cout << "Bitlitas '" << BITLITAS_RELEASE_NAME << "' (v" << BITLITAS_VERSION_FULL << ")" << ENDL << ENDL;
    ...
    {
      std::cout << "Bitlitas '" << BITLITAS_RELEASE_NAME << "' (v" << BITLITAS_VERSION_FULL << ")" << ENDL;
      return 0;
    }
    ...
    // data_dir
    //   default: e.g. ~/.bitlitas/ or ~/.bitlitas/testnet
    ...
    MGINFO("Bitlitas '" << BITLITAS_RELEASE_NAME << "' (v" << BITLITAS_VERSION_FULL << ")");
