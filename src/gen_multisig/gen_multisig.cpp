...
#define BITLITAS_DEFAULT_LOG_CATEGORY "wallet.gen_multisig"
...
int main(int argc, char* argv[])
{
  ...
  const auto vm = wallet_args::main(
   argc, argv,
   "bitlitas-gen-multisig [--testnet] [--filename-base=<filename>] [--scheme=M/N] [--threshold=M] [--participants=N]",
