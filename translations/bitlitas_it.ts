...
<context>
    <name>Bitlitas::AddressBookImpl</name>
    <message>
...
<context>
    <name>Bitlitas::PendingTransactionImpl</name>
    <message>
...
<context>
    <name>Bitlitas::UnsignedTransactionImpl</name>
    <message>
...
<context>
    <name>Bitlitas::WalletManagerImpl</name>
    <message>
...
Avviso: alcune chiavi di input spese vengono da </translation>
    ...
    <message>
        ...
        <source>Available options: seed language - set wallet seed language; always-confirm-transfers &lt;1|0&gt; - whether to confirm unsplit txes; print-ring-members &lt;1|0&gt; - whether to print detailed information about ring members during confirmation; store-tx-info &lt;1|0&gt; - whether to store outgoing tx info (destination address, payment ID, tx secret key) for future reference; default-mixin &lt;n&gt; - set default mixin (default is 4); auto-refresh &lt;1|0&gt; - whether to automatically sync new blocks from the daemon; refresh-type &lt;full|optimize-coinbase|no-coinbase|default&gt; - set wallet refresh behaviour; priority [0|1|2|3|4] - default/unimportant/normal/elevated/priority fee; confirm-missing-payment-id &lt;1|0&gt;; ask-password &lt;1|0&gt;; unit &lt;bitlitas|millinero|micronero|nanonero|piconero&gt; - set default bitlitas (sub-)unit; min-outputs-count [n] - try to keep at least that many outputs of value at least min-outputs-value; min-outputs-value [n] - try to keep at least min-outputs-count outputs of at least that value; merge-destinations &lt;1|0&gt; - whether to merge multiple payments to the same destination address</source>
        <translation>Opzioni disponibili: seed language - seleziona lingua del seed per il portafoglio; always-confirm-transfers &lt;1|0&gt; - se confermare unsplit txes; print-ring-members &lt;1|0&gt; - se mostrare informazioni dettagliate sui ring members durante le conferme; store-tx-info &lt;1|0&gt; - se salvare le informazioni tx in uscita (indirizzo di destinazione, payment ID, chiave tx segreta) per riferimento futuro; default-mixin &lt;n&gt; - imposta default mixin (default è 4); auto-refresh &lt;1|0&gt; - se sincronizzare automaticamente i nuovi blocchi dal daemon; refresh-type &lt;full|optimize-coinbase|no-coinbase|default&gt; - imposta modalità wallet refresh; priority [0|1|2|3|4] - default/unimportant/normal/elevated/priority fee; confirm-missing-payment-id &lt;1|0&gt;; ask-password &lt;1|0&gt;; unit &lt;bitlitas|millinero|micronero|nanonero|piconero&gt; - imposta default bitlitas (sub-)unit; min-outputs-count [n] - cerca di mantenere come minimo tanti outputs quanti il valore di min-outputs-value; min-outputs-value [n] - cerca di mantenere i min-outputs-count outputs come minimo a questo valore; merge-destinations &lt;1|0&gt; - se fondere pagamenti multipli allo stessp indirizzo di destinazione</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>bitlitas, millinero, micronero, nanonero, piconero</source>
        <translation>bitlitas, millinero, micronero, nanonero, piconero</translation>
    </message>
    <message>
...
Usa sempre il comando &quot;exit&quot; quando chiudi bitlitas-wallet-cli per salvare
...
<context>
    ...
    <message>
        ...
        <source> Bitlitas Address = </source>
        <translation> Indirizzo Bitlitas = </translation>
    </message>
    <message>
